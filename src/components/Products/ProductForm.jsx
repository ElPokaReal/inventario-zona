...
import { X, Save, Package, Hash, FileText, Tag, Hash as HashIcon, MapPin, BarChart3, ToggleLeft, ToggleRight } from 'lucide-react';
  ...
  useEffect(() => {
    if (product) {
      setFormData({
        ...
        stock_maximo: product.stock_maximo || null,
        ubicacion: product.ubicacion || '',
        estado: product.estado || 'disponible',
        esta_activo: product.esta_activo !== undefined ? product.esta_activo : true
      });
    }
  }, [product]);
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                {product ? 'Modifique los datos del artículo' : 'Complete la información del artículo'}
              </p>
            </div>
          </div>
          <button
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="md:col-span-2">
              ...
              <div className="relative">
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  rows={3}
                  className={`w-full pl-10 pr-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 resize-none ${
                    errors.descripcion ? 'border-red-300 bg-red-50' : 'border-gray-300 bg-gray-50 focus:bg-white'
                  }`}
                  placeholder="Descripción detallada del artículo, especificaciones técnicas, características, etc."
                />
              </div>
              {errors.descripcion && (
            ...
            <div>
              ...
              <div className="relative">
                ...
                <select
                  ...
                  onChange={handleChange}
                  className={`w-full pl-10 pr-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 ${
                    errors.categoria_id ? 'border-red-300 bg-red-50' : 'border-gray-300 bg-gray-50 focus:bg-white'
                  }`}
                >
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="Número de serie o rango de series"
                />
              </div>
              <p className="mt-1 text-xs text-gray-500">Opcional: Para artículos con números de serie únicos</p>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full pl-10 pr-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 ${
                    errors.stock_actual ? 'border-red-300 bg-red-50' : 'border-gray-300 bg-gray-50 focus:bg-white'
                  }`}
                />
              </div>
              {errors.stock_actual && (
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full pl-10 pr-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 ${
                    errors.stock_minimo ? 'border-red-300 bg-red-50' : 'border-gray-300 bg-gray-50 focus:bg-white'
                  }`}
                />
              </div>
              {errors.stock_minimo && (
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full pl-10 pr-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 ${
                    errors.stock_maximo ? 'border-red-300 bg-red-50' : 'border-gray-300 bg-gray-50 focus:bg-white'
                  }`}
              ...
              <p className="mt-1 text-xs text-gray-500">Opcional: Dejar vacío para sin límite máximo</p>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full pl-10 pr-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 ${
                    errors.ubicacion ? 'border-red-300 bg-red-50' : 'border-gray-300 bg-gray-50 focus:bg-white'
                  }`}
            ...
            <div>
              ...
              <select
                ...
                onChange={handleChange}
                className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-gray-50 focus:bg-white transition-all duration-200"
              >
          ...
          <div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <p className="text-sm text-gray-600">
                {formData.esta_activo 
                  ? 'El artículo estará disponible para movimientos' 
                  : 'El artículo no estará disponible para movimientos'
                }
              </p>
            </div>
          </div>
          ...
          <div className="flex space-x-3 pt-4 border-t border-gray-200">
            ...
            >
              <Save size={18} />
              <span>{isSubmitting ? 'Guardando...' : (product ? 'Actualizar' : 'Crear')}</span>
            </button>
          </div>
        </form>
      </div>
